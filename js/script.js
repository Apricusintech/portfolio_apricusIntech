...
/* ==============================================
    ...
    $(window).on('load', function() {
      ...
      var defaultFilter = '.website-app';  // Set the default filter for "Website App"
  
      // Initialize Isotope with default filter
      $portfolio.isotope({
          itemSelector: '.portfolio-item',
          layoutMode: 'fitRows',
          filter: defaultFilter // Show only "Website App" items on load
      });
  
      // Set the "active" class for the default filter button
      $portfolio_selectors.removeClass('active');
      $('.portfolio-filter > li > a[data-filter="' + defaultFilter + '"]').addClass('active');
